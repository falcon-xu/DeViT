...
def get_args_parser():
    ...
    parser.add_argument('--teacher-path', type=str,
                        default=r'F:\program_lab\python\py3\decomposition_cv\output\finished\cifar100_division5\sub_no_distill')
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default=r'F:\program_lab\python\py3\decomposition_cv\dataset\cifar100\division5',
                        type=str,
                        help='dataset path')
